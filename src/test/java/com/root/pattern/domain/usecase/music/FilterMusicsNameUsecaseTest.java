...
class FilterMusicsNameUsecaseTest {
    @Mock
    ...
    @BeforeEach
    public void setup() {
        this.sut = FilterMusicsNameUsecase.builder()
    ...
    public void shouldCallSutWithCorrectProvidedParams() {
        FilterMusicsNameUsecase mockSut = Mockito.mock(FilterMusicsNameUsecase.class);
    ...
    public void shouldReturnSutOutputIfNothingGoesWrong() {
        ...
        Assertions.assertAll("Sut output assertions",
            ...
            () -> Assertions.assertTrue(outputSut.getMusics().get(0).getIsSingle()),
            () -> Assertions.assertFalse(outputSut.getMusics().get(1).getIsSingle()),
