...
class ListMusicianAlbumsUsecaseTest {
    @Mock
    ...
    @BeforeEach
    public void setup() {
        this.sut = ListMusicianAlbumsUsecase.builder()
    ...
    public void shouldCallSutWithCorrectProvidedParams() {
        ListMusicianAlbumsUsecase mockSut = Mockito.mock(ListMusicianAlbumsUsecase.class);
