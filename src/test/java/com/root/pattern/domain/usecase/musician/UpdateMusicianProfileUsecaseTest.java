...
class UpdateMusicianProfileUsecaseTest {
    @Mock
    ...
    @BeforeEach
    void setup() {
        this.sut = UpdateMusicianProfileUsecase.builder()
    ...
    void shouldCallSutWithCorrectlyProvidedParams() {
        ...
        UpdateMusicianProfileUsecase mockSut = Mockito.mock(UpdateMusicianProfileUsecase.class);
        mockSut.exec(input);
