...
class FilterOneMusicUsecaseImplTest {
    @Mock
    ...
    @BeforeEach
    public void setup() {
        this.sut = FilterOneMusicUsecaseImpl.builder()
    ...
    public void shouldCallSutWithCorrectProvidedParams() {
        ...
        FilterOneMusicUsecase mockSut = Mockito.mock(FilterOneMusicUsecaseImpl.class);
