...
class FilterMusicianMusicsUsecaseImplTest {
    @Mock
    ...
    @BeforeEach
    public void setup() {
        this.sut = FilterMusicianMusicsUsecaseImpl.builder()
    ...
    public void shouldCallSutWithCorrectlyProvidedParams() {
        FilterMusicianMusicsUsecase mockSut = Mockito.mock(FilterMusicianMusicsUsecaseImpl.class);
        mockSut.exec(1L, 1, 5);
    ...
    public void shouldReturnSutOutputIfNothingGoesWrong() {
        ...
        Assertions.assertAll("Sut output assertions",
            ...
            () -> Assertions.assertNotNull(outputSut.getMusics().get(0).getId()),
            () -> Assertions.assertEquals("any_name", outputSut.getMusics().get(0).getName()),
