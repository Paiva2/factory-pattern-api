...
import com.root.pattern.domain.interfaces.usecase.UpdateMusicianProfileUsecase;
...
@AllArgsConstructor
@Builder
public class UpdateMusicianProfileUsecaseImpl implements UpdateMusicianProfileUsecase {
